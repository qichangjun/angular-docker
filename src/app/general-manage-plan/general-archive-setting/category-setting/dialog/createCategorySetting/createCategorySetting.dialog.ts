...
@Component({
    selector: 'create-category-setting-dialog',
    templateUrl: './createCategorySetting.dialog.html',
    styleUrls: ['./createCategorySetting.dialog.scss'],
})
export class createCategorySettingComponent {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<createCategorySettingComponent>,
    ...
    async postDate() {
        try{
            ...
            if (this.data.type == 'create'){
                   await this._CategorySettingService.createCategortSetting(this.myForm.value)  
            }else{
                let info : GeneralArchiveSettingRowData = Object.assign(this.data.info,this.myForm.value)
                await this._CategorySettingService.updateCategortSetting(info) 
            }            
